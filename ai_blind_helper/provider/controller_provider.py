...
class ControllerProvider:
    def __init__(self, application_provider, state_provider):
        ...
        self.turn = TurnController(application_provider.turn, application_provider.audio, state_provider.session_task, state_provider.out_queue, state_provider.audio_in_queue, state_provider.start_audio_event, state_provider, self.sfx)